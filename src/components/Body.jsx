...
const Body = () => {
  ...
  return (
    ...
    <div id="home" className="flex relative lg:flex-row flex-col max-w-7xl mx-auto dark:bg-neutral-950 pt-32 lg:pt-0 md:pt-0 items-center min-h-screen justify-between">
      <div className="lg:w-[50%] w-full reveal-left flex flex-col gap-5">
        <h1 className=" lg:text-3xl text-[22px] text-gray-600 dark:text-white font-lato font-semibold">
          Hi, I’m Priyanshu{" "}
        </h1>
        <p className="lg:text-7xl text-4xl pl-5 md:pl-0 lg:pl-0 font-bold dark:text-white"> Frontend </p>{" "}
        <b className="text-yellow-700 text-right lg:text-7xl pr-5 md:pr-0 lg:pr-0 text-4xl dark:text-yellow-600">Developer</b>
        <p className="lg:text-xl text-[16px] lg:pt-4 font-lato text-gray-600 dark:text-white">
          {" "}
          Building modern and responsive web interfaces
        </p>
        <p className="lg:text-xl text-[16px] font-lato text-gray-600 dark:text-white">
  ...
  download="Priyanshu_Frontend_Developer_Resume.pdf"
      ...
      <div className="pt-10 lg:pt-0 md:pt-0 reveal-right">
        <img
          src="mypic.jpg"
          alt="my picture"
    ...
    {showArrow && (
        <div className=" absolute bottom-8 animate-bounce dark:text-yellow-500 left-1/2 -translate-x-1/2 text-yellow-700 flex flex-col items-center gap-2"> 
